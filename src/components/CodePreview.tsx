...
export function CodePreview({ filePath }: { filePath: string | null }) {
      ...
      <div className="code-preview empty">
        <div className="empty-icon">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
            <rect x="8" y="4" width="32" height="40" rx="3" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5" fill="none" />
            <path d="M16 14H32M16 20H28M16 26H30M16 32H24" stroke="rgba(255,255,255,0.1)" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </div>
  ...
  return (
    <div className="code-preview">
      ...
      <pre className="code-block"><code>{file.code}</code></pre>
    </div>
  );
}
